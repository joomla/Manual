...
**plg_shortcodes/services/provider.php**
```php
<?php
...
Using this approach means that you don't need to change your plugin code if the code which is triggering the event changes from using a generic Event class to a specific event class. 

**plg_shortcodes/src/Extension/Shortcode.php**
```php
<?php
