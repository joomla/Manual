...
| Apache[^seo]          | 2.4 +       | 2.4           | https://www.apache.org  <br/>(with mod_mysql, mod_xml, and mod_zlib)                                             |
| Nginx                 | 1.18 +      | 1.10          | https://www.nginx.com/resources/wiki/                                                                            |
| Microsoft IIS [^iis]  | 10 +        | 8             | https://www.iis.net                                                                                              |
...
|-----------------------|----------------|--------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| PHP[^php]             | 8.0            | 5.3.10       | https://www.php.net <br/>(Magic Quotes GPC, MB String Overload = off) <br/>(Zlib Compression Support, XML Support, INI Parser Support, JSON Support, MB Language = Default) |
| Supported Databases   |                |              |                                                                                                                                                                             |
| MySQL[^mysql]         | 5.5.3 +        | 5.1          | https://www.mysql.com <br/>(InnoDB support required)                                                                                                                        |
...
| Supported Web Servers |                |              |                                                                                                                                                                             |
| Apache[^seo]          | 2.4 +          | 2.0          | https://www.apache.org  <br/>(with mod_mysql, mod_xml, and mod_zlib)                                                                                                        |
