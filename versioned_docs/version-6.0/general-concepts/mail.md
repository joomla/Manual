...
:::danger
  Regression found in Joomla! **6.0.2** using `\Joomla\CMS\Mail\Mail`, please check the [regression notice](/updates/54-60/known-issues/6.0.2/#issue-46643--mailer-setsender-does-not-work).
:::
