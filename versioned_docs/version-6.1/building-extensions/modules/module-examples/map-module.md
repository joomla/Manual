...
The source code for the map package is available at [Manual Examples - map package](https://github.com/joomla/manual-examples/tree/main/package-example-maps).
