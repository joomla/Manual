...
Please check the [Backward Compatibility Plugin](https://manual.joomla.org/updates/44-50/compat-plugin.md) for more details.

For more detail check [Compatibility Plugin Joomla! 5.0](https://manual.joomla.org/updates/44-50/compat-plugin).
